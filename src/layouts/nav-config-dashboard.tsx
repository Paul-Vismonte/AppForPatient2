...
const ICONS = {
  ...
  health: icon('ic-blog'),
  doctor: icon('ic-user'),
  medicalRecord: icon('ic-file'),
  prescription: icon('ic-invoice'),
  medicine: icon('ic-product'),
  appointment: icon('ic-appointment-medical'),
};
...
export const navData: NavSectionProps['data'] = [
   ...
   */
  {
    ...
    items: [
      ...
      { title: 'Medical Record', path: paths.dashboard.general.course, icon: ICONS.folder },
      { title: 'Prescription', path: paths.dashboard.general.prescriptions, icon: ICONS.prescription },
      { title: 'Medicines', path: paths.dashboard.general.medicines, icon: ICONS.course }, // Using course icon as a unique representation for medicines

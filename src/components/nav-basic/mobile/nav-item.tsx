...
type NavItemComponent = React.ForwardRefExoticComponent<NavItemProps & React.RefAttributes<HTMLButtonElement>>;
 ...
 * @slot root
 */
const ItemRoot = styled(ButtonBase, { shouldForwardProp })<StyledState & { component?: React.ElementType }>(({
  open,
  theme,
  active,
}) => {

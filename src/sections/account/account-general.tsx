...
export function AccountGeneral() {
  ...
  const currentUser: UpdateUserSchemaType = {
    ...
    country: (user as ExtendedUser)?.country || null,
    address: (user as ExtendedUser)?.address || '',
    state: (user as ExtendedUser)?.state || '',
    city: (user as ExtendedUser)?.city || '',
    zipCode: (user as ExtendedUser)?.zipCode || '',
    about: (user as ExtendedUser)?.about || '',
    isPublic: (user as ExtendedUser)?.isPublic || false,
  };

        ...
        <ComponentBox sx={{ gap: 5 }}>
          <Box sx={{ width: 1, gap: 1.5, display: 'flex' }}>
            <CountrySelect
              ...
              value={singleLabel}
              onChange={(event, newValue) => setSingleLabel(newValue as string | null)}
            />
          ...
          <Stack spacing={1.5} sx={{ width: 1 }}>
            <CountrySelect
              ...
              placeholder="Choose a country"
              value={multiLabel}
              onChange={(event, newValue) => setMultiLabel(newValue as string[])}
            />
          ...
          <Stack spacing={1.5} sx={{ width: 1 }}>
            <CountrySelect
              ...
              placeholder="Choose a country"
              value={multiCode}
              onChange={(event, newValue) => setMultiCode(newValue as string[])}
            />

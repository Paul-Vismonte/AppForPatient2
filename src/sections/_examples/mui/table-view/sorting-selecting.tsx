...
type ApplyFilterProps = {
  inputData: RowData[];
  comparator: (a: { [key: string]: number | string | boolean | null }, b: { [key: string]: number | string | boolean | null }) => number;
};
...
function applyFilter({ inputData, comparator }: ApplyFilterProps) {
  ...
  stabilizedThis.sort((a, b) => {
    const order = comparator(a[0] as unknown as { [key: string]: string | number | boolean | null }, b[0] as unknown as { [key: string]: string | number | boolean | null });

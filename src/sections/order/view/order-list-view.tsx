...
type ApplyFilterProps = {
  ...
  comparator: (a: { [key: string]: number | string | boolean }, b: { [key: string]: number | string | boolean }) => number;
};
...
function applyFilter({ inputData, comparator, filters, dateError }: ApplyFilterProps) {
  ...
  stabilizedThis.sort((a, b) => {
    const aCompare = {
      orderNumber: a[0].orderNumber,
      createdAt: a[0].createdAt || '',
      totalQuantity: a[0].totalQuantity,
      totalAmount: a[0].totalAmount,
      status: a[0].status,
    };
    const bCompare = {
      orderNumber: b[0].orderNumber,
      createdAt: b[0].createdAt || '',
      totalQuantity: b[0].totalQuantity,
      totalAmount: b[0].totalAmount,
      status: b[0].status,
    };
